    ...
    <header className="sticky top-0 z-40 border-b-2 border-dashed border-kraft bg-paper/80 backdrop-blur-md">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <button
          ...
          className="flex items-center gap-2 font-display text-lg italic text-ink group cursor-pointer"
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          {links.map((link) => (
            <button
              ...
              className={cn(
                "relative flex items-center gap-1 rounded-md px-3 py-2 text-sm font-medium transition-all hover:bg-paper-dark cursor-pointer",
